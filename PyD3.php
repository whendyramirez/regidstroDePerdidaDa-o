...
<div class="container"><h3>Registro Nacional de Pérdidas y Daños</h3>
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="PyD3.php">Población y lugares<br> afectados</a>
    </li>
    <li class="nav-item">
    ...
    <div class="tab-content">
      <h3>Sección 3 – Población y lugares afectados</h3><br>
          <table>
              <tbody>
                <tr>
                  <td><label for="fname">Población expuesta</label></td>
                  <td><input type="text" class="form-control" id="fname" name="fname" placeholder="Número total de personas que residen en el área"></td>      
                </tr>
                <tr>
                  <td><label for="lname">Personas fallecidas</label></td>
                  <td><input type="text" class="form-control" id="fname" name="fname" placeholder="Número total de personas que residen en el área"> 
                </td>
                </tr>

                 <tr>
                  <td><label for="fname">Personas desaparecidas</label></td>
                  <td><input type="text" class="form-control" id="fname" name="fname" placeholder="Número total de personas que residen en el área"></td>      
                </tr>

                <tr>
                  <td><label for="lname">Personas heridas</label></td>
                  <td><input type="text" class="form-control" id="fname" name="fname" placeholder="Número total de personas que residen en el área"></td>
                </tr>

                <tr>
                  <td><label for="lname">Personas damnificada</label></td>
                  <td><input type="text" class="form-control" id="fname" name="fname" placeholder="Número total de personas que residen en el área"></td>
                </tr>

                <tr>
                  <td><label for="lname">Personas afectadas</label></td>
                  <td><input type="text" class="form-control" id="fname" name="fname" placeholder="Número total de personas que residen en el área"></td>
                </tr>

                <tr>
                  <td><label for="lname">Personas evacuadas</label></td>
                  <td><input type="text" class="form-control" id="fname" name="fname" placeholder="Número total de personas que residen en el área" ></td>
                </tr>

                <tr>
                  <td><label for="lname">Personas reubicadas</label></td>
                  <td><input type="text" class="form-control" id="fname" name="fname" placeholder="Número total de personas que residen en el área"></td>
                </tr>

                <tr>
                  <td><label for="lname">Hogares afectados</label></td>
                  <td><input type="text" class="form-control" id="fname" name="fname" placeholder="Número total de personas que residen en el área"></td>
                </tr>

                <tr>
                  <td><label for="cars">Grupo prioritario de afectados</label></td>
                  <td><select id="cars" name="cars" class="form-control">
                  <option value="volvo">Seleccionar grupos desproporcionadamente afectados</option>
                  <option value="volvo">niñez</option>
                  <option value="saab">personas mayores</option>
                  <option value="fiat">persona con discapacidad</option>
                  <option value="audi">pueblos índigenas</option>
                  <option value="audi">afrodescendiente</option>
                  <option value="audi">mujeres jefas de hogar</option>
